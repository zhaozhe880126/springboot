package com.zz.boot.scaffold.authmanage.message.job;

import java.util.List;

import com.zz.boot.scaffold.authmanage.entity.SysMessage;
import com.zz.boot.scaffold.authmanage.message.handle.ISendMsgHandle;
import com.zz.boot.scaffold.authmanage.message.handle.enums.SendMsgStatusEnum;
import com.zz.boot.scaffold.authmanage.message.handle.enums.SendMsgTypeEnum;
import com.zz.boot.scaffold.authmanage.service.ISysMessageService;
import com.zz.scaffold.common.util.DateUtils;
