...
import com.zz.boot.scaffold.authmanage.entity.SysDepartRole;
...
import com.zz.boot.scaffold.authmanage.service.*;
import com.zz.scaffold.common.annotation.AutoLog;
import com.zz.scaffold.common.api.result.Result;
import com.zz.scaffold.common.base.base.controller.BaseController;
...
public class SysDepartRoleController extends BaseController<SysDepartRole, ISysDepartRoleService> {
	...
	public Result<?> queryPageList(SysDepartRole sysDepartRole,
		...
		if(ConvertUtils.isEmpty(deptId)){
