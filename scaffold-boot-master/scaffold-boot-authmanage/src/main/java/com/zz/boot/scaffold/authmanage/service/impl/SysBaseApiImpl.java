...
import com.zz.boot.scaffold.authmanage.entity.*;
import com.zz.boot.scaffold.authmanage.mapper.*;
import com.zz.boot.scaffold.authmanage.service.ISysDataSourceService;
import com.zz.boot.scaffold.authmanage.service.ISysDepartService;
import com.zz.boot.scaffold.authmanage.service.ISysDictService;
import com.zz.boot.scaffold.authmanage.util.MinioUtil;
import com.zz.boot.scaffold.authmanage.websocktet.WebSocket;
import com.zz.scaffold.common.base.api.ISysBaseAPI;
import com.zz.scaffold.common.base.vo.*;
import com.zz.scaffold.common.constant.CacheConstant;
import com.zz.scaffold.common.constant.CommonConstant;
import com.zz.scaffold.common.constant.DataBaseConstant;
import com.zz.scaffold.common.exception.ScaffoldBootException;
import com.zz.scaffold.common.util.ConvertUtils;
import com.zz.scaffold.common.util.IPUtils;
import com.zz.scaffold.common.util.SpringContextUtils;
import com.zz.scaffold.common.util.SysAnnmentTypeEnum;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new ScaffoldBootException("消息模板不存在，模板编码："+templateCode);
        }
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new ScaffoldBootException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
