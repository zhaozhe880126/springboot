package com.zz.scaffold.common.base.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws ScaffoldBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws ScaffoldBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (ConvertUtils.isEmpty(username)) {
			throw new ScaffoldBootException("未获取到用户");
		}
		return username;
	}
